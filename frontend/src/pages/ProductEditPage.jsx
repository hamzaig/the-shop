...
const ProductEditPage = () => {
  ...
  const submitHandler = (e) => {
    ...
    dispatch(updateProduct({
      _id: productId,
      name, price, image, brand, category, desc, countInStock,
    }))
  }
        ...
        {loading ? <Loader /> : error ? <Message variant={"danger"}>{error}</Message> : (
          <Form onSubmit={submitHandler}>
            ...
            <Form.Group controlId="desc">
              ...
              <Form.Control type="text" placeholder='Enter Description' value={desc} onChange={(e) => setDesc(e.target.value)}></Form.Control>
            </Form.Group>
